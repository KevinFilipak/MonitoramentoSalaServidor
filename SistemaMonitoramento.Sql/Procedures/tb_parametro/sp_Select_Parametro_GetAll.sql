IF EXISTS (SELECT * FROM sysobjects WHERE name = 'sp_Select_Parametro_GetAll')
    DROP PROCEDURE sp_Select_Parametro_GetAll
GO

CREATE PROCEDURE sp_Select_Parametro_GetAll
(
    @filtro VARCHAR(50) = ''
)
AS
